...
#pragma config CPRA4 = MSTR    //Pin RA4 Ownership Bits->Slave 1 core owns pin.

// FCFGPRB0
#pragma config CPRB0 = MSTR    //Pin RB0 Ownership Bits->Slave 1 core owns pin.
#pragma config CPRB1 = MSTR    //Pin RB1 Ownership Bits->Slave 1 core owns pin.
...
#pragma config CPRC4 = MSTR    //Pin RC4 Ownership Bits->Slave 1 core owns pin.
#pragma config CPRC5 = MSTR    //Pin RC5 Ownership Bits->Slave 1 core owns pin.
#pragma config CPRC6 = MSTR    //Pin RC6 Ownership Bits->Slave 1 core owns pin.
#pragma config CPRC7 = MSTR    //Pin RC7 Ownership Bits->Slave 1 core owns pin.
...
#pragma config CPRC13 = MSTR    //Pin RC13 Ownership Bits->Slave 1 core owns pin.
...
#pragma config CPRD3 = MSTR    //Pin RD3 Ownership Bits->Slave 1 core owns pin.
#pragma config CPRD4 = MSTR    //Pin RD4 Ownership Bits->Slave 1 core owns pin.
...
#pragma config CPRD10 = MSTR    //Pin RD10 Ownership Bits->Slave 1 core owns pin.
